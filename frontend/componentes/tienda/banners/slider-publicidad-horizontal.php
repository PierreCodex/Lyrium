<?php
/**
 * COMPONENTE: Publicidad Horizontal - 3 Cards
 * Muestra 3 banners publicitarios en cards con bordes redondeados
...
$maxBannersPublicidad = ($plan === 'premium') ? 3 : 3;
$bannersPublicidad = [
    ['url' => 'img/BannerVertical/1-BG.webp', 'titulo' => 'Promoción Especial', 'link' => '#'],
    ['url' => 'img/BannerVertical/2-BG.webp', 'titulo' => 'Ofertas Destacadas', 'link' => '#'],
    ['url' => 'img/BannerVertical/3-BG.webp', 'titulo' => 'Nuevos Productos', 'link' => '#'],
];
